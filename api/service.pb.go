...
var file_github_com_grapery_grapery_common_protoc_service_proto_rawDesc = []byte{
	...
	,
...
var file_github_com_grapery_grapery_common_protoc_service_proto_goTypes = []interface{}{
	...
	(*LogoutRequest)(nil),                // 8: grapery.api.LogoutRequest
	(*RegisterRequest)(nil),              // 9: grapery.api.RegisterRequest
	(*ResetPasswordRequest)(nil),         // 10: grapery.api.ResetPasswordRequest
	(*UserInfoRequest)(nil),              // 11: grapery.api.UserInfoRequest
	(*UpdateUserAvatorRequest)(nil),      // 12: grapery.api.UpdateUserAvatorRequest
	(*UserWatchingRequest)(nil),          // 13: grapery.api.UserWatchingRequest
	(*UserGroupRequest)(nil),             // 14: grapery.api.UserGroupRequest
	(*UserFollowingGroupRequest)(nil),    // 15: grapery.api.UserFollowingGroupRequest
	(*UserUpdateRequest)(nil),            // 16: grapery.api.UserUpdateRequest
	(*FetchUserActivesRequest)(nil),      // 17: grapery.api.FetchUserActivesRequest
	(*SearchUserRequest)(nil),            // 18: grapery.api.SearchUserRequest
	(*CreateGroupReqeust)(nil),           // 19: grapery.api.CreateGroupReqeust
	(*GetGroupReqeust)(nil),              // 20: grapery.api.GetGroupReqeust
	(*GetGroupActivesRequest)(nil),       // 21: grapery.api.GetGroupActivesRequest
	(*UpdateGroupInfoRequest)(nil),       // 22: grapery.api.UpdateGroupInfoRequest
	(*DeleteGroupRequest)(nil),           // 23: grapery.api.DeleteGroupRequest
	(*FetchGroupMembersRequest)(nil),     // 24: grapery.api.FetchGroupMembersRequest
	(*SearchGroupReqeust)(nil),           // 25: grapery.api.SearchGroupReqeust
	(*FetchGroupProjectsReqeust)(nil),    // 26: grapery.api.FetchGroupProjectsReqeust
	(*JoinGroupRequest)(nil),             // 27: grapery.api.JoinGroupRequest
	(*LeaveGroupRequest)(nil),            // 28: grapery.api.LeaveGroupRequest
	(*GetProjectRequest)(nil),            // 29: grapery.api.GetProjectRequest
	(*CreateProjectRequest)(nil),         // 30: grapery.api.CreateProjectRequest
	(*UpdateProjectRequest)(nil),         // 31: grapery.api.UpdateProjectRequest
	(*DeleteProjectRequest)(nil),         // 32: grapery.api.DeleteProjectRequest
	(*GetProjectProfileRequest)(nil),     // 33: grapery.api.GetProjectProfileRequest
	(*UpdateProjectProfileRequest)(nil),  // 34: grapery.api.UpdateProjectProfileRequest
	(*WatchProjectReqeust)(nil),          // 35: grapery.api.WatchProjectReqeust
	(*UnWatchProjectReqeust)(nil),        // 36: grapery.api.UnWatchProjectReqeust
	(*SearchProjectRequest)(nil),         // 37: grapery.api.SearchProjectRequest
	(*SearchAllProjectRequest)(nil),      // 38: grapery.api.SearchAllProjectRequest
	(*ExploreProjectsRequest)(nil),       // 39: grapery.api.ExploreProjectsRequest
	(*GetProjectItemsRequest)(nil),       // 40: grapery.api.GetProjectItemsRequest
	(*GetGroupItemsRequest)(nil),         // 41: grapery.api.GetGroupItemsRequest
	(*GetUserItemsRequest)(nil),          // 42: grapery.api.GetUserItemsRequest
	(*GetItemRequest)(nil),               // 43: grapery.api.GetItemRequest
	(*CreateItemRequest)(nil),            // 44: grapery.api.CreateItemRequest
	(*UpdateItemRequest)(nil),            // 45: grapery.api.UpdateItemRequest
	(*DeleteItemRequest)(nil),            // 46: grapery.api.DeleteItemRequest
...
var file_github_com_grapery_grapery_common_protoc_service_proto_depIdxs = []int32{
	...
	8,  // 4: grapery.api.TeamsAPI.Logout:input_type -> grapery.api.LogoutRequest
	9,  // 5: grapery.api.TeamsAPI.Register:input_type -> grapery.api.RegisterRequest
	10, // 6: grapery.api.TeamsAPI.ResetPwd:input_type -> grapery.api.ResetPasswordRequest
	11, // 7: grapery.api.TeamsAPI.UserInfo:input_type -> grapery.api.UserInfoRequest
	12, // 8: grapery.api.TeamsAPI.UpdateUserAvator:input_type -> grapery.api.UpdateUserAvatorRequest
	13, // 9: grapery.api.TeamsAPI.UserWatching:input_type -> grapery.api.UserWatchingRequest
	14, // 10: grapery.api.TeamsAPI.UserGroup:input_type -> grapery.api.UserGroupRequest
	15, // 11: grapery.api.TeamsAPI.UserFollowingGroup:input_type -> grapery.api.UserFollowingGroupRequest
	16, // 12: grapery.api.TeamsAPI.UserUpdate:input_type -> grapery.api.UserUpdateRequest
	17, // 13: grapery.api.TeamsAPI.FetchUserActives:input_type -> grapery.api.FetchUserActivesRequest
	18, // 14: grapery.api.TeamsAPI.SearchUser:input_type -> grapery.api.SearchUserRequest
	19, // 15: grapery.api.TeamsAPI.CreateGroup:input_type -> grapery.api.CreateGroupReqeust
	20, // 16: grapery.api.TeamsAPI.GetGroup:input_type -> grapery.api.GetGroupReqeust
	21, // 17: grapery.api.TeamsAPI.GetGroupActives:input_type -> grapery.api.GetGroupActivesRequest
	22, // 18: grapery.api.TeamsAPI.UpdateGroupInfo:input_type -> grapery.api.UpdateGroupInfoRequest
	23, // 19: grapery.api.TeamsAPI.DeleteGroup:input_type -> grapery.api.DeleteGroupRequest
	24, // 20: grapery.api.TeamsAPI.FetchGroupMembers:input_type -> grapery.api.FetchGroupMembersRequest
	25, // 21: grapery.api.TeamsAPI.SearchGroup:input_type -> grapery.api.SearchGroupReqeust
	26, // 22: grapery.api.TeamsAPI.FetchGroupProjects:input_type -> grapery.api.FetchGroupProjectsReqeust
	27, // 23: grapery.api.TeamsAPI.JoinGroup:input_type -> grapery.api.JoinGroupRequest
	28, // 24: grapery.api.TeamsAPI.LeaveGroup:input_type -> grapery.api.LeaveGroupRequest
	29, // 25: grapery.api.TeamsAPI.GetProject:input_type -> grapery.api.GetProjectRequest
	30, // 26: grapery.api.TeamsAPI.CreateProject:input_type -> grapery.api.CreateProjectRequest
	31, // 27: grapery.api.TeamsAPI.UpdateProject:input_type -> grapery.api.UpdateProjectRequest
	32, // 28: grapery.api.TeamsAPI.DeleteProject:input_type -> grapery.api.DeleteProjectRequest
	33, // 29: grapery.api.TeamsAPI.GetProjectProfile:input_type -> grapery.api.GetProjectProfileRequest
	34, // 30: grapery.api.TeamsAPI.UpdateProjectProfile:input_type -> grapery.api.UpdateProjectProfileRequest
	35, // 31: grapery.api.TeamsAPI.WatchProject:input_type -> grapery.api.WatchProjectReqeust
	36, // 32: grapery.api.TeamsAPI.UnWatchProject:input_type -> grapery.api.UnWatchProjectReqeust
	37, // 33: grapery.api.TeamsAPI.SearchGroupProject:input_type -> grapery.api.SearchProjectRequest
	38, // 34: grapery.api.TeamsAPI.SearchProject:input_type -> grapery.api.SearchAllProjectRequest
	39, // 35: grapery.api.TeamsAPI.ExploreProject:input_type -> grapery.api.ExploreProjectsRequest
	40, // 36: grapery.api.TeamsAPI.GetProjectItems:input_type -> grapery.api.GetProjectItemsRequest
	41, // 37: grapery.api.TeamsAPI.GetGroupItems:input_type -> grapery.api.GetGroupItemsRequest
	42, // 38: grapery.api.TeamsAPI.GetUserItems:input_type -> grapery.api.GetUserItemsRequest
	43, // 39: grapery.api.TeamsAPI.GetItem:input_type -> grapery.api.GetItemRequest
	44, // 40: grapery.api.TeamsAPI.CreateItem:input_type -> grapery.api.CreateItemRequest
	45, // 41: grapery.api.TeamsAPI.UpdateItem:input_type -> grapery.api.UpdateItemRequest
	46, // 42: grapery.api.TeamsAPI.DeleteItem:input_type -> grapery.api.DeleteItemRequest
