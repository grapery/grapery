...
func (s *StoryService) CreateStory(ctx context.Context, req *connect.Request[gen.CreateStoryRequest]) (*connect.Response[gen.CreateStoryResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().CreateStory(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) UpdateStory(ctx context.Context, req *connect.Request[gen.UpdateStoryRequest]) (*connect.Response[gen.UpdateStoryResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().UpdateStory(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) GetStoryInfo(ctx context.Context, req *connect.Request[gen.GetStoryInfoRequest]) (*connect.Response[gen.GetStoryInfoResponse], error) {
	...
	info, err := storyEngineServer.GetStoryEngine().GetStory(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) WatchStory(ctx context.Context, req *connect.Request[gen.WatchStoryRequest]) (*connect.Response[gen.WatchStoryResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().WatchStory(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) UnWatchStory(ctx context.Context, req *connect.Request[gen.UnWatchStoryRequest]) (*connect.Response[gen.UnWatchStoryResponse], error) {
	traceId := getTraceID(ctx)
	zap.L().Info("UnWatchStory called", zap.String("traceId", traceId), zap.Int64("storyId", req.Msg.StoryId), zap.Int64("userId", req.Msg.UserId))
	if req.Msg.GetUserId() <= 0 {
		uid, err := utils.GetUserIDFromContext(ctx)
		if err != nil || uid <= 0 {
			return nil, connect.NewError(connect.CodeUnauthenticated, errors.New("unauthenticated"))
	...
	ret, err := storyEngineServer.GetStoryEngine().UnWatchStory(ctx, req.Msg)
	if err != nil {
		zap.L().Error("UnWatchStory failed", zap.String("traceId", traceId), zap.Error(err))
		return nil, err
	}
	resp := &gen.UnWatchStoryResponse{
		Code:    ret.Code,
		Message: ret.Message,
	}
	zap.L().Info("UnWatchStory success", zap.String("traceId", traceId), zap.Int64("storyId", req.Msg.StoryId), zap.Int64("userId", req.Msg.UserId))
	return connect.NewResponse(resp), nil
}
...
func (s *StoryService) RenderStory(ctx context.Context, req *connect.Request[gen.RenderStoryRequest]) (*connect.Response[gen.RenderStoryResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().RenderStory(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) GetStoryRender(ctx context.Context, req *connect.Request[gen.GetStoryRenderRequest]) (*connect.Response[gen.GetStoryRenderResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().GetStoryRender(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) ContinueRenderStory(ctx context.Context, req *connect.Request[gen.ContinueRenderStoryRequest]) (*connect.Response[gen.ContinueRenderStoryResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().ContinueRenderStory(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) RenderStoryRoleDetail(ctx context.Context, req *connect.Request[gen.RenderStoryRoleDetailRequest]) (*connect.Response[gen.RenderStoryRoleDetailResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().RenderStoryRoleDetail(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) GetStoryRoles(ctx context.Context, req *connect.Request[gen.GetStoryRolesRequest]) (*connect.Response[gen.GetStoryRolesResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().GetStoryRoles(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) GetStoryContributors(ctx context.Context, req *connect.Request[gen.GetStoryContributorsRequest]) (*connect.Response[gen.GetStoryContributorsResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().GetStoryContributors(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) LikeStory(ctx context.Context, req *connect.Request[gen.LikeStoryRequest]) (*connect.Response[gen.LikeStoryResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().LikeStory(ctx, &gen.LikeStoryRequest{
...
func (s *StoryService) UnLikeStory(ctx context.Context, req *connect.Request[gen.UnLikeStoryRequest]) (*connect.Response[gen.UnLikeStoryResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().UnLikeStory(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) SearchStories(ctx context.Context, req *connect.Request[gen.SearchStoriesRequest]) (*connect.Response[gen.SearchStoriesResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().SearchStories(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) UnFollowStoryRole(ctx context.Context, req *connect.Request[gen.UnFollowStoryRoleRequest]) (*connect.Response[gen.UnFollowStoryRoleResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().UnFollowStoryRole(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) GetNextStoryboard(ctx context.Context, req *connect.Request[gen.GetNextStoryboardRequest]) (*connect.Response[gen.GetNextStoryboardResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().GetNextStoryboard(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) TrendingStory(ctx context.Context, req *connect.Request[gen.TrendingStoryRequest]) (*connect.Response[gen.TrendingStoryResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().TrendingStory(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) TrendingStoryRole(ctx context.Context, req *connect.Request[gen.TrendingStoryRoleRequest]) (*connect.Response[gen.TrendingStoryRoleResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().TrendingStoryRole(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) GetStoryImageStyle(ctx context.Context, req *connect.Request[gen.GetStoryImageStyleRequest]) (*connect.Response[gen.GetStoryImageStyleResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().GetStoryImageStyle(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) UpdateStoryImageStyle(ctx context.Context, req *connect.Request[gen.UpdateStoryImageStyleRequest]) (*connect.Response[gen.UpdateStoryImageStyleResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().UpdateStoryImageStyle(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) UpdateStorySenceMaxNumber(ctx context.Context, req *connect.Request[gen.UpdateStorySenceMaxNumberRequest]) (*connect.Response[gen.UpdateStorySenceMaxNumberResponse], error) {
	...
	ret, err := storyEngineServer.GetStoryEngine().UpdateStorySenceMaxNumber(ctx, req.Msg)
	if err != nil {
...
func (s *StoryService) GetStoryParticipants(ctx context.Context, req *connect.Request[gen.GetStoryParticipantsRequest]) (*connect.Response[gen.GetStoryParticipantsResponse], error) {
	traceId := getTraceID(ctx)
	zap.L().Info("GetStoryParticipants called", zap.String("traceId", traceId), zap.Int64("storyId", req.Msg.StoryId))
	ret, err := storyEngineServer.GetStoryEngine().GetStoryParticipants(ctx, req.Msg)
	if err != nil {
		zap.L().Error("GetStoryParticipants failed", zap.String("traceId", traceId), zap.Error(err))
		return nil, err
	}
	zap.L().Info("GetStoryParticipants success", zap.String("traceId", traceId), zap.Int64("storyId", req.Msg.StoryId))
	return connect.NewResponse(ret), nil
}

func (s *StoryService) UpdateStoryAvatar(ctx context.Context, req *connect.Request[gen.UpdateStoryAvatarRequest]) (*connect.Response[gen.UpdateStoryAvatarResponse], error) {
	traceId := getTraceID(ctx)
	zap.L().Info("UpdateStoryAvatar called", zap.String("traceId", traceId), zap.Int64("storyId", req.Msg.StoryId))
	ret, err := storyEngineServer.GetStoryEngine().UpdateStoryAvatar(ctx, req.Msg)
	if err != nil {
		zap.L().Error("UpdateStoryAvatar failed", zap.String("traceId", traceId), zap.Error(err))
		return nil, err
	}
	zap.L().Info("UpdateStoryAvatar success", zap.String("traceId", traceId), zap.Int64("storyId", req.Msg.StoryId))
	return connect.NewResponse(ret), nil
}

func (s *StoryService) UpdateStoryCover(ctx context.Context, req *connect.Request[gen.UpdateStoryCoverRequest]) (*connect.Response[gen.UpdateStoryCoverResponse], error) {
	traceId := getTraceID(ctx)
	zap.L().Info("UpdateStoryCover called", zap.String("traceId", traceId), zap.Int64("storyId", req.Msg.StoryId))
	ret, err := storyEngineServer.GetStoryEngine().UpdateStoryCover(ctx, req.Msg)
	if err != nil {
		zap.L().Error("UpdateStoryCover failed", zap.String("traceId", traceId), zap.Error(err))
		return nil, err
	}
	zap.L().Info("UpdateStoryCover success", zap.String("traceId", traceId), zap.Int64("storyId", req.Msg.StoryId))
	return connect.NewResponse(ret), nil
}

func (s *StoryService) SaveStoryboardCraft(ctx context.Context, req *connect.Request[gen.SaveStoryboardCraftRequest]) (*connect.Response[gen.SaveStoryboardCraftResponse], error) {
	traceId := getTraceID(ctx)
	zap.L().Info("SaveStoryboardCraft called", zap.String("traceId", traceId), zap.Int64("storyId", req.Msg.GetStoryboardId()))
	ret, err := storyEngineServer.GetStoryEngine().SaveStoryboardCraft(ctx, req.Msg)
	if err != nil {
		zap.L().Error("SaveStoryboardCraft failed", zap.String("traceId", traceId), zap.Error(err))
		return nil, err
	}
	zap.L().Info("SaveStoryboardCraft success", zap.String("traceId", traceId), zap.Int64("storyId", req.Msg.GetStoryboardId()))
	return connect.NewResponse(ret), nil
}
