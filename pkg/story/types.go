...
type StoryChapter struct {
	ChapterSummary    ChapterSummary           `json:"章节情节简述"`
	ChapterDetailInfo ChapterDetailInformation `json:"章节详细情节"`
}

// ChapterSummary 表示章节的基本信息
type ChapterSummary struct {
	Title      string      `json:"章节题目"`
	Content    string      `json:"章节内容"`
	Characters []Character `json:"参与人物"`
}

// ChapterDetailInformation 包含多个详细情节
type ChapterDetailInformation struct {
	Details []*DetailScene `json:"详细情节"`
}
...
type Character struct {
	ID          string `json:"角色id"`
	Name        string `json:"角色姓名"`
	Description string `json:"角色描述"`
}

// StoryInfo 表示故事的完整信息
type StoryInfo struct {
	StoryNameAndTheme StoryNameAndTheme `json:"故事名称和主题"`
	StoryChapters     []ChapterInfo     `json:"故事章节"`
}

// StoryNameAndTheme 表示故事的名称和主题信息
type StoryNameAndTheme struct {
	Name        string `json:"故事名称"`
	Theme       string `json:"故事主题"`
	Description string `json:"故事简介"`
}
