...
func (r *IAPReceipt) ConvertToAppleReceipt() *models.AppleReceipt {
	return &models.AppleReceipt{
		ID:                 r.ID,
		UserID:             r.UserID,
...
func (p *IAPPurchase) ConvertToGooglePurchase() *models.GooglePurchase {
...
func (s *IAPSubscription) ConvertToAppleSubscription() *models.AppleSubscription {
	return &models.AppleSubscription{
		ID:                     s.ID,
		UserID:                 s.UserID,
...
func (s *IAPSubscription) ConvertToGoogleSubscription() *models.GoogleSubscription {
	...
	return &models.GoogleSubscription{
		ID:                   s.ID,
		UserID:               s.UserID,
...
// ConvertToAppleSubscription 转换为Apple订阅模型
func (r *IAPReceipt) ConvertToAppleSubscription() *models.AppleSubscription {
	return &models.AppleSubscription{
		UserID:                r.UserID,
