# Grapery Backend - Claude Code Rules

> 基于 Claude Code 团队最佳实践，持续迭代更新
...
### 2. 提示词技巧
- 让 Claude 担任代码审查员：「针对这些改动对我进行严厉质疑和询问」
...
- [Claude Code 最佳实践 - 知乎](https://zhuanlan.zhihu.com/p/2001805409359520847)
- [git worktrees 并行开发](https://code.claude.com/docs/en/common-workflows#run-parallel-claude-code-sessions-with-git-worktrees)
- [Skills 扩展](https://code.claude.com/docs/en/skills#extend-claude-with-skills)
- [Hooks 配置](https://code.claude.com/docs/en/hooks#permissionrequest)
- [终端配置](https://code.claude.com/docs/en/terminal-config)
