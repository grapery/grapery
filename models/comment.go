...
func (c *Comment) GetComment(ctx context.Context) error {
...
func GetCommentByUserID(ctx context.Context, userID uint64, page int64, pageSize int64) (*[]*Comment, error) {
	var ret = new([]*Comment)
...
func IncreaseReplyCount(ctx context.Context, commentID uint64) error {
	if err := DataBase().Model(&Comment{}).
		Where("id = ?", commentID).
...
func DecreaseReplyCount(ctx context.Context, commentID uint64) error {
	if err := DataBase().Model(&Comment{}).
		Where("id = ?", commentID).
		Update("reply_count", gorm.Expr("reply_count - 1")).Error; err != nil {
		return err
...
func GetCommentByStory(ctx context.Context, storyID uint64, commentType int64, page int64, pageSize int64) (*[]*Comment, error) {
	var ret = new([]*Comment)
	if err := DataBase().Model(&Comment{}).
...
func GetCommentListByTimeRange(ctx context.Context, start time.Time, end time.Time, commentType int64, page int64, pageSize int64) (*[]*Comment, error) {
	var ret = new([]*Comment)
	if err := DataBase().Model(&Comment{}).
...
func GetCommentListByStoryBoard(ctx context.Context, storyBoardID uint64, page int64, pageSize int64) (*[]*Comment, error) {
	var ret = new([]*Comment)
	if err := DataBase().Model(&Comment{}).
...
func GetStoryCommentReplies(ctx context.Context, commentID uint64) (*[]*Comment, error) {
	var ret = new([]*Comment)
...
func GetStoryBoardCommentReplies(ctx context.Context, commentID uint64) (*[]*Comment, error) {
	var ret = new([]*Comment)
	if err := DataBase().Model(&Comment{}).Where("root_comment_id = ? and deleted = 0",
		commentID).
		Order("create_at desc").
...
func DeleteComment(ctx context.Context, commentID uint64) error {
	if err := DataBase().Model(&Comment{}).
		Where("id = ?", commentID).
...
func DeleteStoryCommentReply(ctx context.Context, commentID uint64) error {
	if err := DataBase().Model(&Comment{}).
		Where("id = ?", commentID).
		Update("deleted", 1).Error; err != nil {
...
func DeleteStoryBoardCommentReply(ctx context.Context, commentID uint64) error {
	if err := DataBase().Model(&Comment{}).
		Where("id = ?", commentID).
		Update("deleted", 1).Error; err != nil {
...
func LikeComment(ctx context.Context, commentID uint64, userId uint64) error {
	newCommentLike := &CommentLike{
		UserID:    int64(userId),
		CommentID: int64(commentID),
	}
	err := newCommentLike.Create(ctx)
	if err != nil {
		return nil
	}
	if err := DataBase().Model(&Comment{}).
...
func DislikeComment(ctx context.Context, commentID uint64, userId uint64) error {
	isLiked, err := GetCommentLike(ctx, commentID, userId)
	if err != nil {
...
func (c *CommentLike) Create(ctx context.Context) error {
	if err := DataBase().Model(c).Create(c).Error; err != nil {
...
func (c *CommentLike) Delete(ctx context.Context) error {
...
func GetCommentLike(ctx context.Context, commentID uint64, userId uint64) (*CommentLike, error) {
