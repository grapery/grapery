...
type LLMMsgFeedbackType int

const (
	LLMMsgFeedbackTypeLike LLMMsgFeedbackType = iota
	LLMMsgFeedbackTypeDislike
	LLMMsgFeedbackTypeComplaint
)
...
type LLMMsgFeedback struct {
	...
	Type      LLMMsgFeedbackType `gorm:"column:type;size:16" json:"type,omitempty"` // like/dislike/complaint
