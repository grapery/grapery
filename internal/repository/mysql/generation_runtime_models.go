...
type GenerationExecutionDB struct {
	...
	WorkflowReleaseID   string     `gorm:"size:80;index"`
	WorkflowKey         string     `gorm:"size:120;index"`
	WorkflowVersion     int        `gorm:"default:0"`
	WorkflowChecksum    string     `gorm:"size:64"`
	PromptBundleJSON    string     `gorm:"type:longtext"`
	PromptSnapshotsJSON string     `gorm:"type:longtext"`
