...
func (r *Repository) CreateCharacter(ctx context.Context, character *domain.Character) error {
	...
	dbCharacter := Character{
		...
		SourceFragmentID:           optionalStringPtr(character.SourceFragmentID),
		SourceFragmentCharacterKey: optionalStringPtr(character.SourceFragmentCharacterKey),
...
func (r *Repository) UpdateCharacter(ctx context.Context, character *domain.Character) error {
	...
	updates := map[string]interface{}{
		...
		"source_fragment_id":            optionalStringPtr(character.SourceFragmentID),
		"source_fragment_character_key": optionalStringPtr(character.SourceFragmentCharacterKey),
