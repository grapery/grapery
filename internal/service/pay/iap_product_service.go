	...
	defaultProducts := []*paymodels.IAPProduct{
		{
			...
			TrialPeriod:  utils.StringPtr("P7D"),
			MaxRoles:     50,
			MaxContexts:  50,
			QuotaLimit:   1000000 * 12,
			AppleSKU:     utils.StringPtr("com.rankquantity.voyager.sub_basic_y"),
			Featured:     true,
			DisplayOrder: 1,
		},
		{
			...
			MaxContexts:  50,
			QuotaLimit:   1000000,
			AppleSKU:     utils.StringPtr("com.rankquantity.voyager.sub_basic_m"),
			Featured:     true,
			DisplayOrder: 2,
		},
		{
			...
			AppleSKU:     utils.StringPtr("com.rankquantity.voyager.sub_premium_y"),
			Featured:     true,
			DisplayOrder: 3,
		},
		{
			...
			MaxContexts:  500,
			QuotaLimit:   50000000,
			AppleSKU:     utils.StringPtr("com.rankquantity.voyager.sub_premium_m"),
			Featured:     true,
			DisplayOrder: 4,
		},
		{
			...
			AppleSKU:     utils.StringPtr("com.rankquantity.voyager.sub_pro_y"),
			Featured:     true,
			DisplayOrder: 5,
		},
		{
			...
			MaxContexts:  200,
			QuotaLimit:   2000000,
			AppleSKU:     utils.StringPtr("com.rankquantity.voyager.sub_pro_m"),
			Featured:     true,
			DisplayOrder: 6,
		},
		// Google Play 产品
		{
			...
			MaxContexts:  50,
			QuotaLimit:   1000000 * 12,
			GoogleSKU:    utils.StringPtr("com.rankquantity.voyager.sub_basic_y"),
			Featured:     true,
			DisplayOrder: 1,
		},
		{
			...
			MaxContexts:  50,
			QuotaLimit:   1000000,
			GoogleSKU:    utils.StringPtr("com.rankquantity.voyager.sub_basic_m"),
			Featured:     true,
			DisplayOrder: 2,
		},
		{
			...
			MaxContexts:  500,
			QuotaLimit:   50000000 * 12,
			GoogleSKU:    utils.StringPtr("com.rankquantity.voyager.sub_premium_y"),
			Featured:     true,
			DisplayOrder: 3,
		},
		{
			...
			MaxContexts:  500,
			QuotaLimit:   50000000,
			GoogleSKU:    utils.StringPtr("com.rankquantity.voyager.sub_premium_m"),
			Featured:     true,
			DisplayOrder: 4,
		},
		{
			...
			MaxContexts:  200,
			QuotaLimit:   2000000 * 12,
			GoogleSKU:    utils.StringPtr("com.rankquantity.voyager.sub_pro_y"),
			Featured:     true,
			DisplayOrder: 5,
		},
		{
			...
			MaxContexts:  200,
			QuotaLimit:   2000000,
			GoogleSKU:    utils.StringPtr("com.rankquantity.voyager.sub_pro_m"),
			Featured:     true,
			DisplayOrder: 6,
		},
	}
