...
func (c *CompositeIAPService) GetReceiptValidationHistory(ctx context.Context, userID uint64, limit int) ([]*paymodels.IAPReceiptValidation, error) {
	return c.persistenceService.GetReceiptValidationHistory(ctx, userID, limit)
}

// GetUserPaymentHistory 获取用户支付历史
func (c *CompositeIAPService) GetUserPaymentHistory(ctx context.Context, userID uint64, limit int) ([]*paymodels.PaymentRecord, error) {
	return c.persistenceService.GetUserPaymentHistory(ctx, userID, limit)
}

// GetUserSubscriptionHistory 获取用户订阅历史
func (c *CompositeIAPService) GetUserSubscriptionHistory(ctx context.Context, userID uint64, limit int) ([]*paymodels.UserSubscription, error) {
